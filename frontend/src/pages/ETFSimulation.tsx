            ...
            {rows.map((row, index) => {
              ...
              return (
                <tr key={id}>
                  ...
                  <td>{rawValue == null ? '—' : money(Number(rawValue), 3)}</td>
